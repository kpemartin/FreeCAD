...
public:
    ...
    /// Break an object Name or Label into its base parts, returning tuple(baseName, nameExtension, digitCount, digitsValue)
    std::tuple<std::string, std::string, uint, uint>
    decomposeName(const std::string& name);
